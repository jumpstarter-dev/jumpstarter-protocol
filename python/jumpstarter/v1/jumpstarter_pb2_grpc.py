...
def add_ForExporterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Register': grpc.unary_unary_rpc_method_handler(
                    servicer.Register,
                    request_deserializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.ExporterReport.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'ControlStream': grpc.stream_stream_rpc_method_handler(
                    servicer.ControlStream,
                    request_deserializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.ClientResponse.FromString,
                    response_serializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.ServerCommand.SerializeToString,
            ),
            'Bye': grpc.unary_unary_rpc_method_handler(
                    servicer.Bye,
                    request_deserializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.ExporterBye.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'DataStream': grpc.stream_stream_rpc_method_handler(
                    servicer.DataStream,
                    request_deserializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.DataChunk.FromString,
                    response_serializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.DataChunk.SerializeToString,
            ),
            'EventStream': grpc.stream_stream_rpc_method_handler(
                    servicer.EventStream,
                    request_deserializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.Event.FromString,
                    response_serializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.Event.SerializeToString,
            ),
    }
...
def add_ForClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetReport': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.ExporterReport.SerializeToString,
            ),
            'ControlStream': grpc.stream_stream_rpc_method_handler(
                    servicer.ControlStream,
                    request_deserializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.ServerCommand.FromString,
                    response_serializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.ClientResponse.SerializeToString,
            ),
            'DataStream': grpc.stream_stream_rpc_method_handler(
                    servicer.DataStream,
                    request_deserializer=jumpstarter_dot_v1_dot_jumpstarter__pb2.DataChunk.FromString,
